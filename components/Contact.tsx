...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:mohsen.abyari1994@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\n${formData.message}`)}`
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <a
                  href="mailto:mohsen.abyari1994@gmail.com"
                  className="text-primary-turquoise hover:underline"
                >
                  mohsen.abyari1994@gmail.com
                </a>
              </div>
            </div>
